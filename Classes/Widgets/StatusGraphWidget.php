...
/**
 * Class StatusGraphWidget
 *
 * @package Walther\JiraServiceDesk\Widgets
 */
class StatusGraphWidget implements WidgetInterface, EventDataInterface, AdditionalCssInterface, RequireJsModuleInterface
{
    /**
    ...
    /**
     * @var \Walther\JiraServiceDesk\Widgets\Provider\StatusGraphWidgetDataProvider
     */
     ...
     * @param \Walther\JiraServiceDesk\Widgets\Provider\StatusGraphWidgetDataProvider $dataProvider
     ...
     * @param array                                                                   $options
     */
    public function __construct(WidgetConfigurationInterface $configuration, StatusGraphWidgetDataProvider $dataProvider, Cache $cache, StandaloneView $view, $buttonProvider = null, array $options = [])
    {
    ...
    {
        $this->view->setTemplate('Widget/StatusGraph');
    ...
    {
        $cacheHash = md5('getChartDataStatusGraph');
